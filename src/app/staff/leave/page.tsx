...
const STATUS_LABEL: Record<string, {label:string; color:string; bg:string}> = {
  ...
  approved: { label: 'موافَق عليها ✓',   color: '#16a34a', bg: '#f0fdf4' },
  ...
  return (
    <div style={{minHeight:'100vh',background:'#f7f7f5',fontFamily:"'IBM Plex Sans Arabic',system-ui",direction:'rtl',paddingBottom:40}}>
      ...
      <div style={{maxWidth:520,margin:'0 auto',padding:'20px 16px'}}>
        {balance !== null && (
          <div style={{background:'linear-gradient(135deg,#0d2818,#16a34a)',borderRadius:16,padding:'18px 20px',marginBottom:20,textAlign:'center' as const}}>
        ...
        <div style={{background:'white',border:'1.5px solid #ece8e2',borderRadius:14,padding:'16px',marginBottom:20}}>
          ...
          <button onClick={submitRequest} disabled={submitting||!startDate||!endDate}
            style={{width:'100%',padding:'12px',background:(submitting||!startDate||!endDate)?'#94a3b8':'#16a34a',color:'white',border:'none',borderRadius:10,fontSize:14,fontWeight:700,cursor:(submitting||!startDate||!endDate)?'not-allowed':'pointer',fontFamily:'inherit'}}>
