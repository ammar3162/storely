...
export async function POST(req: Request) {
  try {
    ...
    if (orgId) {
      ...
      const directTables = ['notifications','purchases','staff_members','whatsapp_logs','push_subscriptions','cashier_closings','fixed_expenses','monthly_fixed_expenses','inventory_snapshots','supplier_orders','staff_leave_requests','staff_notifications','staff_payroll_adjustments','staff_tasks','demo_requests']
