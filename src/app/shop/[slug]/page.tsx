          ...
          <div style={{display:'flex',alignItems:'center',gap:12}}>
            ...
            <div>
              <div style={{display:'flex',alignItems:'center',gap:8}}>
                ...
                {status.known && (
                  <span style={{display:'inline-flex',alignItems:'center',gap:5,fontSize:10,fontWeight:700,padding:'3px 9px',borderRadius:99,background:status.open?'#f0fdfa':'#fef2f2',color:status.open?'#029FA2':'#dc2626',border:`1px solid ${status.open?'#99f6e4':'#fecaca'}`}}>
                    <span style={{width:6,height:6,borderRadius:'50%',background:status.open?'#029FA2':'#dc2626'}}/>
                    {status.label}
                  </span>
                )}
              </div>
