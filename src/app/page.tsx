...
const PLANS = [
  { name: 'الأساسية', price: '99', branches: 'فرع واحد', color: '#16a34a', features: ['تتبع المخزون', 'تنبيهات واتساب', 'موظف واحد', 'التقارير', 'نسخ احتياطي'] },
  { name: 'المتوسطة', price: '199', branches: '2-3 فروع', color: '#2563eb', popular: true, features: ['كل مميزات الأساسية', 'حتى 3 فروع', 'موظفون غير محدودين', 'تقارير موسعة', 'دعم أولوي'] },
  { name: 'المتقدمة', price: '349', branches: '4+ فروع', color: '#7c3aed', features: ['كل مميزات المتوسطة', 'فروع غير محدودة', 'تقارير مخصصة', 'دعم مخصص 24/7'] },
]
