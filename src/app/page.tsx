...
const PLANS = [
  ...
  { name: 'المتوسطة', price: '249', popular: true, limits: { branches: 'فرعين', employees: '5 موظفين', suppliers: '5 موردين' }, features: ['كل مميزات الأساسية', 'إقفال الكاشير اليومي 💰', 'تقارير متقدمة', 'تقرير الربحية الشهري 📈', 'اقتراح الشراء الذكي 🤖', 'دعم ذو أولوية'] },
  { name: 'المتقدمة', price: '399', popular: false, limits: { branches: 'غير محدود', employees: 'غير محدود', suppliers: 'غير محدود' }, features: ['كل مميزات المتوسطة', 'مقارنة أداء الفروع 🤖', 'تحليل الموسمية', 'كشف الهدر والتالف', 'دعم 24/7'] },
]
