      ...
      <div className="main">
        ...
        <div className="topbar">
          ...
          <div style={{display:'flex',alignItems:'center',gap:8}}>
            <button onClick={()=>navigate('/notifications')} style={{position:'relative',width:36,height:36,borderRadius:8,border:'1px solid #e2e8f0',background:'white',cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center'}}>
              ...
              {low > 0 && <span style={{position:'absolute',top:-4,left:-4,background:'#ef4444',color:'white',fontSize:9,fontWeight:700,padding:'1px 4px',borderRadius:8,minWidth:16,textAlign:'center'}}>{low}</span>}
            </button>
