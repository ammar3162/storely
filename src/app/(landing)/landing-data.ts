...
export const PLANS = [
  { name:'الأساسية', nameEn:'Basic', price:'99', yearlyPrice:'950', color:'#0f766e', popular:false,
    ...
    addonNote:'🧩 توسّعها وقت ما تحتاج بإضافات اختيارية — موظفين/موردين إضافيين، إدارة موظفين كاملة، إقفال كاشير، ذكاء اصطناعي وأكثر',
    addonNoteEn:'🧩 Expand it anytime with optional add-ons — extra staff/suppliers, full HR management, cashier closing, AI tools and more' },
