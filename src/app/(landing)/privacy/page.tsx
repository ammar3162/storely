    ...
    <div style={{fontFamily:"'IBM Plex Sans Arabic',system-ui,sans-serif",direction:'rtl',minHeight:'100vh',background:'#f8fafc'}}>
      ...
      <div style={{maxWidth:800,margin:'0 auto',padding:'48px 24px'}}>
        ...
        {[
          ...
          {
            title:'3. تطبيق الجوال — الأذونات المستخدمة',
            content:'عند استخدام تطبيق Storely على الجوال (أندرويد/iOS)، نطلب الأذونات التالية فقط، وكل وحدة لها غرض محدد:\n• الإشعارات (Notifications): لإرسال تنبيهات فورية عند نقص المخزون، إقفال الكاشير، أو تأكيد طلبات التوريد — تقدر توقفها بأي وقت من إعدادات جوالك\n• الكاميرا (Camera): تُستخدم فقط لما تصوّر فاتورة شراء لقراءتها آلياً (OCR) وتعبئة بيانات المشتريات تلقائياً — الصورة تُرفع وتُحلّل، ولا تُستخدم لأي غرض ثاني\n\nما نطلب أي إذن ثاني (لا الموقع الجغرافي، لا جهات الاتصال، لا الميكروفون).'
          },
          {
            title:'4. بيانات الموظفين المضافين من صاحب الحساب',
          ...
          {
            title:'8. منصة السوق (Marketplace) للموردين',
