      ...
      <div style={{maxWidth:800,margin:'0 auto',padding:'48px 24px'}}>
        ...
        {[
          ...
          },
          {
            ...
            content:'نجمع البيانات التالية:\n• بيانات الحساب: الاسم، البريد الإلكتروني، رقم الجوال\n• بيانات المنشأة: اسم المنشأة، نوع النشاط، عدد الفروع\n• بيانات المخزون: المنتجات، الكميات، المشتريات، سجلات الصرف\n• بيانات الاستخدام: سجلات الدخول، النشاط داخل النظام\n• بيانات الموظفين الذين يضيفهم صاحب الحساب (اسم، رقم جوال) — راجع القسم التالي'
          },
          {
            title:'3. بيانات الموظفين المضافين من صاحب الحساب',
            content:'يقدر صاحب حساب المنشأة يضيف موظفين (اسم ورقم جوال) لإدارة الصرف أو إقفال الكاشير. هذي البيانات:\n• يضيفها صاحب الحساب مباشرة، وليست تسجيل ذاتي من الموظف\n• تُستخدم فقط لتشغيل حساب الموظف داخل النظام (تسجيل دخول برمز PIN، استقبال رسائل واتساب متعلقة بعمله)\n• يشوفها صاحب الحساب فقط داخل منشأته، ولا تُعرض لأي منشأة أو مستخدم ثاني\n• على صاحب الحساب إبلاغ موظفيه بأن بياناتهم مسجّلة بالنظام وبالغرض منها\n\nسجلات الإقفال والعمليات المالية المرتبطة باسم الموظف تبقى محفوظة كسجل مالي حتى بعد حذف الموظف من النظام — احتفاظ إلزامي بمقتضى الأنظمة المحاسبية، وليس اختيارياً (تفاصيل أوسع بالقسم 9).'
          },
          {
          ...
          },
          {
            ...
            content:'نحمي بياناتك باستخدام:\n• تشفير SSL/TLS لجميع الاتصالات\n• قواعد بيانات مشفرة على خوادم آمنة\n• نسخ احتياطية أسبوعية تلقائية\n• صلاحيات وصول محدودة للموظفين\n\nفريق Storely الفني قد يصل لبيانات حسابك للدعم الفني أو حل مشكلة تقنية، دائماً بأقل صلاحية ضرورية ومع تسجيل من قام بالإجراء.'
          },
          {
            title:'6. مشاركة البيانات',
            content:'لا نشارك بياناتك مع أطراف ثالثة إلا في الحالات التالية:\n• بموافقتك الصريحة\n• عند الضرورة القانونية بأمر قضائي\n• مع مزودي الخدمة الضروريين لتشغيل المنصة (Supabase للتخزين، Resend للإيميل، WasenderAPI لإرسال إشعارات واتساب)'
          },
          {
            title:'7. منصة السوق (Marketplace) للموردين',
            content:'لو قدّمت طلب شراكة كمورد، بيانات شركتك (الاسم ورقم التواصل) تُعرض بمنصة السوق العامة داخل Storely — فقط لو وافقت صراحة على ذلك وقت تقديم الطلب، وفقط بعد قبول طلبك. تقدر تطلب إزالة بياناتك من السوق بأي وقت بالتواصل معنا.'
          },
          {
            title:'8. حقوقك',
          ...
          },
          {
            ...
            content:'نحتفظ ببياناتك طالما حسابك نشط. عند حذف الحساب، نحذف بياناتك التشغيلية (المخزون، الموظفين، الفروع) نهائياً.\n\nاستثناء إلزامي: السجلات المالية (المبيعات، الإقفالات، المشتريات) تبقى محفوظة حتى لو انحذف الموظف أو الحساب المرتبط بها، لأن الأنظمة المحاسبية بالمملكة تفرض الاحتفاظ بالسجلات المالية لمدة محددة قانوناً — هذا احتفاظ إلزامي مو اختياري من طرفنا.'
          },
          {
