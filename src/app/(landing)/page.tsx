...
const PLANS = [
  { name: 'الأساسية', price: '149', branches: 'فرع واحد', color: '#16a34a', features: ['تتبع المخزون الكامل', 'تنبيهات واتساب', 'موظف واحد', 'التقارير الأساسية', 'نسخ احتياطي تلقائي'] },
  { name: 'المتوسطة', price: '249', branches: '2-3 فروع', color: '#2563eb', popular: true, features: ['كل مميزات الأساسية', 'حتى 3 فروع', 'موظفون غير محدودين', 'تقارير موسّعة', 'دعم ذو أولوية'] },
