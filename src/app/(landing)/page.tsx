...
const PLANS = [
  ...
  { name:'المتوسطة', price:'249', color:'#16a34a', popular:true,
    ...
    features:['تتبع المخزون','تنبيهات واتساب','إدارة الموظفين','تقارير أساسية','إدارة الموردين','تقارير متقدمة','إقفال الكاشير اليومي','اقتراح الشراء الذكي 🤖','—','دعم ذو أولوية','—'] },
  { name:'المتقدمة', price:'399', color:'#16a34a', popular:false,
    limits:['غير محدود','غير محدود','غير محدود'],
    features:['تتبع المخزون','تنبيهات واتساب','إدارة الموظفين','تقارير أساسية','إدارة الموردين','تقارير متقدمة','إقفال الكاشير اليومي','اقتراح الشراء الذكي 🤖','مقارنة الفروع 🤖','دعم ذو أولوية','دعم 24/7'] },
]
